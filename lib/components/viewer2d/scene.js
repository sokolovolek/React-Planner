  ...
  _createClass(Scene, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'g',
        null,
        _react2.default.createElement(_export.Grids, { scene: scene }),
        _react2.default.createElement(
          ...
          layers.entrySeq().filter(function (_ref) {
            ...
            return _react2.default.createElement(_export.Layer, { key: layerID, layer: layer, scene: scene, catalog: catalog });
          })
        ),
        _react2.default.createElement(_export.Layer, { key: selectedLayer.id, layer: selectedLayer, scene: scene, catalog: catalog })
      );
    }
  }]);
